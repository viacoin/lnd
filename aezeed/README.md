...
[In this PR](https://github.com/viacoin/lnd/pull/773) we added a new package implementing the aezeed cipher
...
goos: linux
goarch: amd64
pkg: github.com/viacoin/lnd/aezeed
...
PASS
ok      github.com/viacoin/lnd/aezeed  4.168s
```
