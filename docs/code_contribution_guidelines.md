...
- Changes to behavior within the daemon's interaction with the P2P protocol,
  ...
  [`networkHarness`framework](https://github.com/viacoin/lnd/blob/master/lntest/harness.go)
...
[perusing the make file documentation](https://github.com/viacoin/lnd/blob/master/docs/MAKEFILE.md).
...
definitions, check out the [lnrpc README](https://github.com/viacoin/lnd/blob/master/lnrpc/README.md).
